...
- **Optional** `release-count`: Number of releases to preserve in changelog. Default `5`, use `0` to regenerate all. If `input-file` is used, any releases included in that file are not included in this count.
